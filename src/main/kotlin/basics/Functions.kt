...
class Functions {
     ...
     * 1.   A simple function that takes a parameter of type String and returns Unit (i.e., no return value).
              ( "Unit" return type in optional, you can remove that also)

       2.   A function that takes a second optional parameter with
                default value Info. The return type is omitted, meaning that it's actually Unit.
                If nothing is passed to "prefix" then it's default value will be "Info"

       3.   A function that takes two integer as argument and
                returns an integer i.e., there sum.
